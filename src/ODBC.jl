...
type Metadata
    querystring::ASCIIString
    cols::Int
    rows::Int
    colnames::Array{ASCIIString}
    coltypes::Array{(ASCIIString, Int16)}
    colsizes::Array{Int}
...
typealias Output Union(DataType,ASCIIString)

const null_resultset = DataFrame()
const null_conn = Connection("", 0, C_NULL, C_NULL, null_resultset)
const null_meta = Metadata("", 0, 0, ASCIIString[], (ASCIIString,Int16)[], Int[], Int16[], Int16[])
