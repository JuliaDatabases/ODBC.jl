...
#Status: Tested on Windows, Linux, Mac 32/64-bit
function SQLSetEnvAttr{T<:@compat(Union{Int,UInt})}(env_handle::Ptr{Void}, attribute::Int, value::T)
    @windows_only begin
...
#Status:
function SQLSetConnectAttr(dbc::Ptr{Void},attribute::Int,value::@compat(Union{AbstractString,UInt}),value_length::Int)
