...
#Status:
function SQLSetConnectAttr(dbc::Ptr{Void},attribute::Int,value::Union(ASCIIString,Uint),value_length::Int)
    @windows_only ret = ccall( (:SQLSetConnectAttr, odbc_dm), stdcall,
        Int16, (Ptr{Void},Int,typeof(value)==ASCIIString?Ptr{Uint8}:Ptr{Uint},Int),
...
# Status:
function SQLConnect(dbc::Ptr{Void},dsn::ASCIIString,username::ASCIIString,password::ASCIIString)
...
#Status:
function SQLDriverConnect(dbc::Ptr{Void},window_handle::Ptr{Void},conn_string::ASCIIString,out_conn::Ptr{Void},out_buff::Array{Int16,1},driver_prompt::Uint16)
...
#SQLBrowseConnect
 ...
 #Status:
function SQLBrowseConnect(dbc::Ptr{Void},instring::ASCIIString,outstring::Array{Uint8,1},indicator::Array{Int16,1})
...
#Status:
function SQLNativeSql(dbc::Ptr{Void},query_string::ASCIIString,output_string::Array{Uint8,1},length_ind::Array{Int,1})
...
function SQLPrepare(stmt::Ptr{Void},query_string::ASCIIString)
...
#Status:
function SQLExecDirect(stmt::Ptr{Void},query::ASCIIString)
...
function SQLBindCols(stmt::Ptr{Void},x::Int,ctype::Int16,holder::Array{ASCIIString,1},jlsize::Int,indicator::Array{Int,1})
    @windows_only ret = ccall( (:SQLBindCol, odbc_dm), stdcall,
...
function SQLSetCursorName(stmt::Ptr{Void},cursor::ASCIIString)
...
function SQLColumns(stmt::Ptr{Void},catalog::ASCIIString,schema::ASCIIString,table::ASCIIString,column::ASCIIString)
...
function SQLColumnPrivileges(stmt::Ptr{Void},catalog::ASCIIString,schema::ASCIIString,table::ASCIIString,column::ASCIIString)
    @windows_only ret = ccall( (:SQLColumnPrivileges, odbc_dm), stdcall,
        Int16, (Ptr{Void},Ptr{Uint8},Int16,Ptr{Uint8},Int16,Ptr{Uint8},Int16,Ptr{Uint8},Int16),
        stmt,catalog,sizeof(catalog),schema,sizeof(schema),table,sizeof(table),column,sizeof(column))
    @unix_only ret = ccall( (:SQLColumnPrivileges, odbc_dm),
...
function SQLForeignKeys(stmt::Ptr{Void},pkcatalog::ASCIIString,pkschema::ASCIIString,pktable::ASCIIString,fkcatalog::ASCIIString,fkschema::ASCIIString,fktable::ASCIIString)
...
function SQLPrimaryKeys(stmt::Ptr{Void},catalog::ASCIIString,schema::ASCIIString,table::ASCIIString)
...
function SQLProcedureColumns(stmt::Ptr{Void},catalog::ASCIIString,schema::ASCIIString,proc::ASCIIString,column::ASCIIString)
...
function SQLProcedures(stmt::Ptr{Void},catalog::ASCIIString,schema::ASCIIString,proc::ASCIIString)
...
function SQLTables(stmt::Ptr{Void},catalog::ASCIIString,schema::ASCIIString,table::ASCIIString,table_type::ASCIIString)
...
function SQLTablePrivileges(stmt::Ptr{Void},catalog::ASCIIString,schema::ASCIIString,table::ASCIIString)
...
#Status:
function SQLStatistics(stmt::Ptr{Void},catalog::ASCIIString,schema::ASCIIString,table::ASCIIString,unique::Uint16,reserved::Uint16)
...
#Status:
function SQLSpecialColumns(stmt::Ptr{Void},id_type::Int16,catalog::ASCIIString,schema::ASCIIString,table::ASCIIString,scope::Int16,nullable::Int16)
