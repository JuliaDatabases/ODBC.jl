...
latex_documents = [
  ('index', 'ODBC.jl.tex', u'ODBC.jl Documentation',
   AUTHORS, 'manual'),
]
...
man_pages = [
    ('index', 'ODBC.jl', u'ODBC.jl Documentation',
     [AUTHORS], 1)
]
...
texinfo_documents = [
  ('index', 'ODBC.jl', u'ODBC.jl Documentation',
   AUTHORS, 'ODBC.jl', 'A low-level ODBC interface for the Julia programming language',
   'Miscellaneous'),
]
